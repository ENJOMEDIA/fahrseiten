  ...
  return [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Der Kunde räumt FahrSeiten für die Vertragsdauer die einfachen, räumlich auf die vertragsgemäße Veröffentlichung beschränkten Nutzungsrechte ein, die zur Speicherung, technischen Bearbeitung, Vervielfältigung, öffentlichen Zugänglichmachung und Auslieferung der freigegebenen Inhalte erforderlich sind. Weitergehende Rechte werden nicht übertragen.",
        "Wird eine mögliche Rechtsverletzung nachvollziehbar gemeldet, muss der Kunde an der Prüfung mitwirken und Rechtebelege vorlegen. FahrSeiten darf den betroffenen Inhalt bis zur Klärung verhältnismäßig sperren. Der Kunde stellt FahrSeiten von berechtigten Ansprüchen Dritter und angemessenen Kosten der Rechtsverteidigung frei, soweit diese auf einer von ihm schuldhaft verursachten Verletzung seiner Pflichten aus diesem Abschnitt beruhen. Dies gilt nicht für eigenständige Änderungen oder Inhalte von FahrSeiten.",
