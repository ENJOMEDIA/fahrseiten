...
Der ursprüngliche Plan nannte netcup Webhosting 8000 als erstes Kompatibilitätsziel. Mit dem Auftrag vom 17. September 2026 ist ein Linux-Plesk-System das aktuelle erste Deploymentziel. Ein direkter Git-Pull mit anschließendem, über das Plesk-Node.js-Toolkit ausgeführtem Standalone-Build sowie Plesk-Einstiegspunkte sind vorbereitet. Der netcup-Support bestätigte am 23. September 2026 gemeinsamen Dokumentenstamm, unveränderten Host-Header, eigene Zertifikate je Domain und den grundsätzlichen Mehrkundenbetrieb. Node-/Plesk-Laufzeit und Builds wurden auf dem realen Hosting bereits ausgeführt; Ressourcen, persistenter Uploadspeicher, Lastverhalten, Backup und Restore bleiben offene Betriebsnachweise (OD-14).
...
Jede Funktion im zentralen Feature-Katalog muss ihre Auswirkungen auf die Datenschutzbausteine und einen möglichen Bedarf an eigenen Kunden-AGB ausdrücklich deklarieren. Die wirksame Kombination aus gebuchtem Paket und Mandanten-Freischaltungen steuert diese Anforderungen serverseitig. Neue Pflichtbausteine erscheinen sofort in Consent-Konfiguration und Rechtstext-Vorschau; eine veröffentlichte Fassung wird dabei bewusst nicht ungeprüft überschrieben. Die Instanz weist auf die notwendige Prüfung und erneute Veröffentlichung hin. FahrSeiten-AGB regeln ausschließlich das B2B-Verhältnis zwischen ENJO MEDIA und der Fahrschule. Eigene Buchungs-, Zahlungs-, Storno- oder Widerrufsbedingungen einer Fahrschule müssen vor Freigabe entsprechender transaktionaler Module gesondert konfiguriert und geprüft werden.
