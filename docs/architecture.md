...
Der ursprüngliche Plan nannte netcup Webhosting 8000 als erstes Kompatibilitätsziel. Mit dem Auftrag vom 17. September 2026 ist ein Linux-Plesk-System das aktuelle erste Deploymentziel. Ein direkter Git-Pull mit anschließendem Next.js-Standalone-Build sowie Plesk-Einstiegspunkte sind vorbereitet; Node-/Plesk-Version, Ausführung der Deployment-Aktion, Proxy-Verhalten, Domain-/SSL-Limits, Cron, Schreibrechte, Uploadspeicher und Ressourcen bleiben bis zur Prüfung am Zielsystem offene Punkte (OD-03, OD-06 und OD-14).
